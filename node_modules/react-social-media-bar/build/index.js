...
var SocialMediaBar = function (_React$Component) {
  _inherits(SocialMediaBar, _React$Component);

  function SocialMediaBar() {
    _classCallCheck(this, SocialMediaBar);

    return _possibleConstructorReturn(this, (SocialMediaBar.__proto__ || Object.getPrototypeOf(SocialMediaBar)).apply(this, arguments));
  }
  ...
  _createClass(SocialMediaBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          iconOpacity = _props.iconOpacity,
          iconSize = _props.iconSize,
          hoverColor = _props.hoverColor,
          hoverOpacity = _props.hoverOpacity,
          margin = _props.margin,
          padding = _props.padding,
          sameTab = _props.sameTab,
          vertical = _props.vertical;


      var generatedIcons = icons.map(function (icon, index) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement('i', { className: 'fa-' + icon.media + ' fa', 'aria-hidden': 'true' })
        );
      });

      return _react2.default.createElement(
        ContainerDiv,
        { bgColor: bgColor, vertical: vertical },
        generatedIcons
      );
    }
  }]);
...
var ContainerDiv = _styledComponents2.default.div(_templateObject, function (_ref) {
...
ContainerDiv.propTypes = {
  icons: _propTypes2.default.arrayOf(_propTypes2.default.object).isRequired,
  bgColor: _propTypes2.default.string,
  iconColor: _propTypes2.default.string,
  iconOpacity: _propTypes2.default.number,
  iconSize: _propTypes2.default.string,
  hoverColor: _propTypes2.default.string,
  hoverOpacity: _propTypes2.default.number,
  margin: _propTypes2.default.objectOf(_propTypes2.default.string),
  padding: _propTypes2.default.objectOf(_propTypes2.default.string),
  sameTab: _propTypes2.default.bool,
...
var IconAnchor = _styledComponents2.default.a(_templateObject2, function (_ref3) {
  var iconColor = _ref3.iconColor;
  return iconColor;
}, function (_ref4) {
  var iconOpacity = _ref4.iconOpacity;
  return iconOpacity;
}, function (_ref5) {
  ...
  return !_.isUndefined(hoverColor) ? hoverColor : iconColor;
}, function (_ref15) {
  var hoverOpacity = _ref15.hoverOpacity;
  return hoverOpacity;
});
...
var setOpacity = function setOpacity(opacity, parentOpacity) {
  return !_.isUndefined(opacity) ? opacity : parentOpacity;
};

var setTarget = function setTarget(sameTab, parentSameTab) {
